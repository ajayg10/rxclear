...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`lp-navbar lp-animate-fade-in ${isScrolled ? "scrolled" : ""}`} aria-label="Main navigation">
        <div className="lp-navbar-inner">
          ...
          <div className="lp-navbar-actions">
            <a
              ...
              aria-label="View RXCLEAR on GitHub"
            >
              ...
              <span className="lp-nav-action-text">GitHub</span>
            </a>
            <Link to="/app" className="lp-btn-primary" id="nav-try-rxclear" aria-label="Try RXCLEAR">
              <span className="lp-nav-action-text">Try RXCLEAR</span> <span className="lp-arrow" aria-hidden="true">→</span>
            </Link>
          </div>
