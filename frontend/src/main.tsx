      ...
      <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden text-xs text-slate-400 sm:block">
            Decodes Prescriptions • Finds Alternatives • Buy Online
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="text-center py-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-teal-500/10 px-3 py-1 text-xs font-bold text-teal-300 border border-teal-500/20 mb-3">
            <span>✨ Powered by Anthropic Claude 3.5 Haiku on AWS Bedrock</span>
          </div>
              ...
              <div className="glass-card rounded-2xl p-4 border border-teal-500/30">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-bold uppercase tracking-wider text-teal-400 flex items-center gap-1.5">
                    <span>📷 Uploaded Doctor Prescription Image</span>
                  </span>
            ...
            <div className="glass-card rounded-2xl p-6 border-l-4 border-l-teal-500">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400">{analysis.doctorDetails.qualification} • {analysis.doctorDetails.clinic}</p>
                </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
                        <div>
                          ...
                          <p className="mt-1 text-xs text-slate-400">
                            Dosage: <strong className="text-slate-200">{med.dosage}</strong> • Duration: <strong className="text-slate-200">{med.duration}</strong>
                          </p>
                        </div>
                        ...
                        <div className="shrink-0 flex items-center gap-2">
                          ...
                          >
                            <span>{available ? "In Stock" : "⚠️ Marked NOT Available"}</span>
